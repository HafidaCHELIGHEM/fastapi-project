...
class InfiniteGridMenu {
  ...
  #render() {
    ...
    gl.clearColor(0.941, 0.941, 0.941, 1.0);
  ...
  return (
    <div className="w-ful">
      <canvas
        ...
        ref={canvasRef}
        className="cursor-grab w-full px-4  h-full overflow-hidden relative outline-none active:cursor-grabbing"
      />
      ...
      {activeItem && (
        ...
        `}
          >
            <p className="select-none relative text-[#f0f0f0] top-[2px] text-[26px]">
              &#x2197;
            </p>
          </div> */}
      ...
      `}
          >
            <ArrowUpRight
              className="text-[#f0f0f0] relative top-[2px]"
              size={26}
            />
          </Link>
        </>
